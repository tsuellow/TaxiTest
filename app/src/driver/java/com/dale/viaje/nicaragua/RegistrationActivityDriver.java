...
public class RegistrationActivityDriver extends RegistrationActivityBasic {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buildTooltips(infoPlate,getString(R.string.registrationdriver_infoplate),0.90f);
        buildTooltips(infoDesc,getString(R.string.registrationdriver_infocar),0.90f);

        //photo car
        photoCar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(),getString(R.string.registrationactivitybasic_awaitcamera), Toast.LENGTH_SHORT).show();
    ...
    public String getVehicleTypeCode(String name){
        if (name.contentEquals(getString(R.string.registerdriver_taxi))) {
            return "taxi";
        }else if (name.contentEquals(getString(R.string.registerdriver_tuktuk))) {
            return "caponera";
        }else if (name.contentEquals(getString(R.string.registerdriver_biketaxi))) {
            return "bicitaxi";
        }else if (name.contentEquals(getString(R.string.registerdriver_minibus))) {
            return "minibus";
        }else if (name.contentEquals(getString(R.string.registerdriver_mototaxi))) {
            return "moto";
        }else {
            return "otro";
        }
