...
public class BarriosLayer extends VectorLayer {
    ...
    public BarriosLayer(Map map, Context context, int barriosResourceId) {
        ...
        nowhere.add(new GeoPoint(-0.1,-0.1));
        nowhere.add(new GeoPoint(0.1,-0.1));
        noBarrioSelected=new BarrioPolygonDrawable(entireCountry,BarrioPolygonDrawable.sb.fillColor(Color.BLACK).build(),context.getString(R.string.barrioslayer_outsideofcity),-1);
        noDestinationSelected=new BarrioPolygonDrawable(nowhere,BarrioPolygonDrawable.sb.fillColor(Color.WHITE).build(), context.getString(R.string.barrioslayer_empty),-2);
    }
