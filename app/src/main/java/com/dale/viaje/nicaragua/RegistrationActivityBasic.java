...
import com.dale.viaje.nicaragua.connection.MultipartRequest;
...
public class RegistrationActivityBasic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.registrationactivitybasic_title);
        ...
        //TODO this doesnt need the enters anymore get it done
        buildTooltips(infoFirst,getString(R.string.registrationactivitybasic_infofirst),0.9f);
        buildTooltips(infoLast,getString(R.string.registrationactivitybasic_infolast),0.9f);
        buildTooltips(infoPhone,getString(R.string.registrationactivitybasic_infophone),0.90f);
        buildTooltips(infoSharePhone,getString(R.string.registrationactivitybasic_infosharephone),0.90f);
        ...
        photoFace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(), R.string.registrationactivitybasic_awaitcamera, Toast.LENGTH_SHORT).show();
    ...
    public boolean checkIsEmpty(EditText editView, TextInputLayout layout){
        if (editView.getText().toString().trim().isEmpty()){
            ...
            editView.setError(getString(R.string.registrationactivitybasic_inputrequired));
    ...
    private boolean checkPhoneNumber(){
        ...
        try{
            ...
            if (checkText.length()>=11){
                ...
                //loPhone.setErrorEnabled(false);
                phoneNr.setError(getString(R.string.registrationactivitybasic_invalidphone));
                return false;
            }
        }catch(Exception e){
            Toast.makeText(getApplicationContext(),phoneText,Toast.LENGTH_SHORT).show();
            //loPhone.setErrorEnabled(false);
            phoneNr.setError(getString(R.string.registrationactivitybasic_faultyphone));
            return  false;
        }
    }
    ...
    public void registerWithFormData(JSONObject json, Map<String,DataPart> files, Map<String,String> headers, Context context){
        ...
        MultipartRequest multipartRequest=new MultipartRequest(requestMethod, Constants.SERVER_URL + apiExtension, headers,  new Response.Listener<NetworkResponse>() {
            ...
            public void onResponse(NetworkResponse response) {
                ...
                try {
                    ...
                    if (res.equals("OK")) {
                        ...
                        Toast.makeText(context, R.string.registrationactivitybasic_jsonerror,Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                String errorMessage = getString(R.string.registrationactivitybasic_unknownerror);
                if (networkResponse == null) {

                        errorMessage = getString(R.string.registrationactivitybasic_failedtoconnect);
                    ...
                    try {
                        ...
                        if (networkResponse.statusCode == 404) {
                            errorMessage = getString(R.string.registrationactivitybasic_resnotfound);
                        } else if (networkResponse.statusCode == 401) {
                            errorMessage = message+getString(R.string.registrationactivitybasic_loginagain);
                        } else if (networkResponse.statusCode == 400) {
                            errorMessage = message+ getString(R.string.registrationactivitybasic_checkinputs);
                        } else if (networkResponse.statusCode == 500) {
                            errorMessage = message+getString(R.string.registrationactivitybasic_somethingiswrong);
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
    ...
    public void defineRegistrationDialogStrings(String id){
        titleOngoing=getString(R.string.registrationactivitybasic_registrationongoing);
        textOngoing=getString(R.string.registrationactivitybasic_textongoing);
        titleSuccess=getString(R.string.registrationactivitybasic_registrationsuccess);
        textSuccess=getString(R.string.registrationactivitybasic_textsuccess)+" <b>" + id + "</b>" + getString(R.string.registrationactivitybasic_textsucess2);
        titleError=getString(R.string.registrationactivitybasic_error);
        textError=getString(R.string.registrationactivitybasic_errortext);
    }
    ...
    public Dialog makeTermsOfUseDialog(Context context){
        ...
        titleView.setText(getString(R.string.termsandconditions));
