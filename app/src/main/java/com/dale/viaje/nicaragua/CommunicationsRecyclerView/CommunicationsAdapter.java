...
import com.dale.viaje.nicaragua.RecordButtonUtils.RecordButton;
...
public class CommunicationsAdapter extends RecyclerView.Adapter<CommunicationsAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final CommunicationsAdapter.ViewHolder holder, int position) {
        ...
        holder.descriptionText.setText(R.string.commsadapter_invite);
        ...
        final CountDownTimer recordingTimer=new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                holder.descriptionText.setText(R.string.commsadapter_recordingended);
                ...
                switch (currComm.getButtonCode()){
                    ...
                    case  CommsObject.AWAITING:
                        ...
                        if (currComm.getNextUnplayedMsj()==null) {
                            Toast.makeText(mContext, R.string.commsadapter_awaitingresponsetoast, Toast.LENGTH_LONG).show();
                        }else{
                    ...
                    case  CommsObject.BT_ACCEPTED:
                        //paint btn black
                        if (currComm.getNextUnplayedMsj()==null){
                            Toast.makeText(mContext, R.string.commsadapter_taxialreadyaccepted, Toast.LENGTH_LONG).show();
                        }else{
                            currComm.startPlaying(currComm.getNextUnplayedMsj(),holder.progressBar);
                            sendAndRegisterOwnAck(new AcknowledgementObject(currComm.getNextUnplayedMsj().getMsjObject(),CommsObject.PLAYED));
                        }
    ...
    public void repaintButton(CommsObject currComm, FloatingActionButton fab, LinearLayout ackBubble, TextView descriptionText, TextView descriptionPointer){
        //TODO add button animations and compress code (LOW PRIORITY)
        switch (currComm.getButtonCode()){
            case  CommsObject.AWAITING:
                //do nothing, only toast/play own msg
                ...
                repaintDescription(mContext.getString(R.string.commsadapter_awaitingresponse),ContextCompat.getColor(mContext, R.color.colorDeselected),descriptionText,descriptionPointer);
                break;
            case  CommsObject.PLAY:
                //start playing
                ...
                repaintDescription(mContext.getString(R.string.commsadapter_playaudio),ContextCompat.getColor(mContext, R.color.colorGreen),descriptionText,descriptionPointer);
                break;
            case  CommsObject.ACCEPT:
                //send acceptance
                ackBubble.setVisibility(View.GONE);
                ...
                repaintDescription(mContext.getString(R.string.commsadapter_accept),ContextCompat.getColor(mContext, R.color.colorGreen),descriptionText,descriptionPointer);
                break;
            case  CommsObject.BT_ACCEPTED:
                //paint btn black
                ...
                repaintDescription(mContext.getString(R.string.commsadapter_accepted),Color.BLACK,descriptionText,descriptionPointer);
                break;
            default:
                ackBubble.setVisibility(View.GONE);
                ...
                repaintDescription(mContext.getString(R.string.commsadapter_invite),ContextCompat.getColor(mContext,R.color.colorBlueDark),descriptionText,descriptionPointer);
        }
        fab.hide();
        fab.show();
    }
