...
public class CommsObject {
    ...
    public class CardData{
        ...
        public String gender= mContext.getString(R.string.male);
    ...
    public void addAtTopOfMsjList(MetaMessageObject msj){
        ...
        if (!msj.isOutgoing && msj.getMsjObject().getIntentCode()!=REJECTED){
            ...
            MiscellaneousUtils.showNotification(mContext,mContext.getString(R.string.commsobject_youwerecontacted), mContext.getString(R.string.commsobject_youwerecontacteddesc));
        }
        //change comm status
        if (msjList.size()==1){
    ...
    public void showCommsDialog(Context context){
        ...
        if (commCardData==null){
            title.setText(R.string.commsobject_chatunknown);
            name.setText(R.string.commsobject_unknown);
        }else{
            title.setText(context.getString(R.string.commsobject_chatwith)+" "+commCardData.firstName);
