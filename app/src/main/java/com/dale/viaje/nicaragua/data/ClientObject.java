...
import static com.dale.viaje.nicaragua.utils.MiscellaneousUtils.reducePrecision;
...
//    }
    ...
    public String objectToCsv(){
        String result=null;
        try{
            result=""+this.taxiId +"|"+reducePrecision(this.latitude)+"|"+reducePrecision(this.longitude)+"|"+this.locationTime+"|"+this.rotation+"|"+this.seats+"|"+this.extra+"|"+reducePrecision(this.destinationLatitude)+"|"+reducePrecision(this.destinationLongitude)+"|"+this.isActive;
        }catch (Exception e){
            e.printStackTrace();
        }
        return result;
