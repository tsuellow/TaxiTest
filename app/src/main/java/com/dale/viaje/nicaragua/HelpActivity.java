...
import com.dale.viaje.nicaragua.utils.GenericDialogUtils;
...
//        display.getSize(output);
        ...
        adapter=new HelpVideoAdapter(new HelpVideos(getApplicationContext()).getVideoList(),this);
        ...
        adapter.setVideoClickedListener(new HelpVideoAdapter.VideoClickedListener() {
            ...
            public void onVideoClicked(HelpVideoObject videoObject) {
                if (player!=null){
                    ...
                    Toast.makeText(getApplicationContext(), R.string.helpactivity_videoloadingalert, Toast.LENGTH_LONG).show();
                }
...
//        });
    ...
    void setupDocuments(){
        readTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GenericDialogUtils.makeScrollableTextDialog(mContext,getString(R.string.helpactivity_termsofuse),GenericDialogUtils.testText).show();
            }
        });
        ...
        readDataUse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GenericDialogUtils.makeScrollableTextDialog(mContext,getString(R.string.helpactivity_datapolicy),GenericDialogUtils.testText).show();
            }
        });
    }
