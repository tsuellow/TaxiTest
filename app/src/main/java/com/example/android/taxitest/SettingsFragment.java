...
public class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void showFilterDialog(){
        ...
        title.setText("Filter amplitude");
        String barSuffix="degrees";
        ...
        buildTooltips(dialog.getContext(), info,"high values mean you will see more taxis of different colors, " +
                "low values tht those taxis you see will go close to your destination",0.1f);
    ...
    public void showTaxiAmountDialog(){
        ...
        title.setText("Number of taxis shown");
        String barSuffix="taxis";
        ...
        buildTooltips(dialog.getContext(), info,"defines how many taxis are shown on the map on average. " +
                "Reduce this number if your device gets slow. Increase it if you find not enough options are shown",0.1f);
